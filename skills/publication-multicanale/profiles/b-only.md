# Profil éditorial — B-Only

## Périmètre

Communication liée à B-Only : programme, intervenants, partenaires, billetterie, informations pratiques, contenus pédagogiques liés aux conférences et communications post-événement.

## Source de vérité renforcée

Avant toute communication sensible, appliquer `skills/b-only-source-of-truth/SKILL.md`.

Sources prioritaires :

- `projects/b-only/`
- `projects/b-only/INTERVENANTS.md`
- fichiers programme B-Only
- Issues B-Only correspondantes
- `dashboard/NOW.md`
- Pretix pour la billetterie
- Paheko/Dolibarr pour les statuts financiers lorsque nécessaires
- Nextcloud pour visuels et médias

## Publics

- participants potentiels ;
- communautés Bitcoin francophones ;
- personnes intéressées par les enjeux monétaires, techniques et sociétaux ;
- partenaires et intervenants.

## Ton

Direct, pédagogique, exigeant mais accessible. Valoriser la qualité des sujets, la diversité des approches et l’expérience collective sans survendre l’événement.

## CTA principal

Lorsque pertinent : réservation B-Only via la billetterie officielle.

## Règles spécifiques

- ne jamais annoncer un intervenant non confirmé ;
