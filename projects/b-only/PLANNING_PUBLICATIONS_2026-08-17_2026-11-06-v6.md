...
| 7–12 septembre | **7–9 septembre — Polto et Darko** : « Justifier l'origine de ses bitcoins » | `PRÊT À RELIRE` | **10–12 septembre — Pierre Noizat** : « Energie, monnaie et civilisation » | `PRÊT À RELIRE` — campagne V1, Blog/Nostr commun et Reel HeyGen préparés ; liens à créer |
| 14–19 septembre | **14–16 septembre — Christine Jeanneaux** : « Et si on comptait les moutons ? — Anatomie d’un mimétisme autour de Bitcoin » | `PRÊT À RELIRE` — campagne V4 préparée | **17–19 septembre — Alexandre Stachtchenko** | `À COMPLÉTER` — sujet, titre, portrait et contenu manquants |
| 21–26 septembre | **21–23 septembre — Nicolas Cantu** : « Lire les dégâts de l’impression monétaire dans les sols. » | `À PRODUIRE` | **24–26 septembre — Florent Gabriel** | `À COMPLÉTER` — titre et contenu manquants |
...
| 5–10 octobre | **5–7 octobre — Schnuartz** : Specter Workshop | `À COMPLÉTER` | **8–10 octobre — Jean** : achat de bitcoin de manière privée | `À COMPLÉTER` |
...
| Pierre Noizat | `campaigns/pierre-noizat/calendrier-diffusion-v1.csv` | Contenus V1 |
