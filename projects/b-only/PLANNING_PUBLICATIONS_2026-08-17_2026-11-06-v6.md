...
| Pierre Noizat | `campaigns/pierre-noizat/calendrier-diffusion-v1.csv` | Première version — PR #140, diffusion en cours ; trois preuves dans `campaigns/pierre-noizat/publications-v1.csv` |
