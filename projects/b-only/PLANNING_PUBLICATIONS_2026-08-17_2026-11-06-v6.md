...
| 21–26 septembre | **21–23 septembre — Élodie Lué** : « Paiements via Lightning Network » | `À PRODUIRE` — remplace Jean ; modalités des commerçants à préciser | **24–26 septembre — Florent Gabriel** : « L’IA est-elle en train de sauver ou de tuer de Bitcoin ? » | `À PRODUIRE` — fonction, portrait et logos reçus ; vignette brouillon V5 à valider ; synopsis et contenus multicanaux à préparer |
