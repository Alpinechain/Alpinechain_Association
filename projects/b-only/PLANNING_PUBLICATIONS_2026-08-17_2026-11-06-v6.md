...
| 21–26 septembre | **21–23 septembre — Lionel Jeannerat** : « Bitcoin pour les Copain.e.s » | `PRÊT À RELIRE` — campagne avancée depuis le 1er–3 octobre ; titre, angle, portrait et vignette validés ; sept vouchers et alias actifs ; participation/créneau et droits du portrait à confirmer avant programmation | **24–26 septembre — Florent Gabriel** : « L’IA est-elle en train de sauver ou de tuer Bitcoin ? » | `VALIDÉ / LIENS ACTIFS / VISUEL À VALIDER` — angle, textes et calendrier validés ; V6 corrigée à valider ; session `confirmed/internal`, droits/crédit du portrait et contrôle des aperçus requis avant programmation |
...
| Florent Gabriel | `campaigns/florent-gabriel/calendrier-diffusion-v1.csv` | Première version — prête à relire |
