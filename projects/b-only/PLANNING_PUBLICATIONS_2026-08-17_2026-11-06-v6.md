...
|---|---|---|---|---|
| 17–22 août | **17–19 août — Élodie Lué** : « Quand Bitcoin rencontre le mobile money » | `PRÊT À RELIRE` — contenu V4 et calendrier V4 | **20–22 août — Aurore Galves** : « Have Fun Staying Fun — Les mèmes, le langage de la révolution monétaire » | `PRÊT À RELIRE` — textes validés, calendrier V3 à relire |
| 24–29 août | **24–26 août — ProfEduStream** : parcours des quatre workshops pratiques | `PRÊT À RELIRE` — contenu validé, calendrier V3 à relire | **27–29 août — ProfEduStream** : « Face à la menace quantique, faut-il geler les bitcoins de Satoshi ? » | `PRÊT À RELIRE` — contenu validé, calendrier V3 à relire |
