...
- portrait réintégré depuis la photo originale pour éviter la pixellisation
  observée sur la V4 ;
...
- portrait source :
  `01_Programme-Intervenants/Photos Intervenants/intervenant--florent-gabriel--portrait--2026-09-01--source.jpeg` ;
- logos sources :
