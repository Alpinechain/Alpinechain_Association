...
Vue centrée sur les personnes physiquement ou publiquement associées à B-Only'26. Complète `INTERVENANTS.md` et `ORGANISATIONS.md`. Nextcloud reste la source des fichiers portraits et logos. Racine archives historiques : `/f/971`.
...
- `N/A` : compte indiqué comme inexistant/inactif.
- `?` : identité, rattachement ou compte à confirmer.
- Les handles fournis directement par l'organisation sont conservés comme source primaire ; les recherches web servent à compléter ou confirmer.

## Participants — assets et réseaux

| Personne | Rôle | Structure / projet | Photo | Logo | X | Nostr | LinkedIn | Instagram | Facebook | YouTube / autre | État / note |
|---|---|---|---|---|---|---|---|---|---|---|---|
...
- Christine Jeanneaux — portrait 2026 + vignette validée.
- Élodie Lué — portrait 2026 + vignette validée.
- Alexandre Poltorak / Polto — portrait 2026 validé.
- Darko Gasic — portrait 2026 validé.

## Personnes indisponibles — hors liste active 2026

| Personne | Statut |
|---|---|
| Élodie Sogan | Indisponible |
| Cédric Maire | Indisponible |
...
Règle : ne jamais déduire un handle ou un npub à partir d'un simple pseudo. Les comptes Nostr ne sont enregistrés que lorsqu'un npub est fourni directement ou publié par la personne / une source directement liée.
