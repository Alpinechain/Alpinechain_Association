...
|---|---|---|---|---|---|---|---|
| Pierre Noizat | Confirmé | Paymium | Dimanche 9 h 30, salle principale ; format 20 minutes | Trois portraits disponibles par défaut dans `03_Communication/Vignettes/Intervenants/` | À dater | Titre, thème exact et sélection du portrait | Obtenir les éléments puis faire valider la vignette |
...
| Renaud Lifchitz | Planifié | Sharekey — CTO | Dimanche 15 h 30, workshop technique — « Reticulum, le réseau cypherpunk dont vous avez besoin ! » | Portrait officiel reçu dans `03_Communication/Vignettes/Intervenants/intervenant--renaud-lifchitz--portrait-officiel--2026-07-24--source.jpg` | Portrait, titre professionnel et titre du workshop reçus | Synopsis, besoins techniques et confirmation définitive du créneau | Préparer la vignette et obtenir les besoins techniques |
| Élodie Sogan | Indisponible | À préciser | Ne participera pas à l’édition 2026 ; créneau du samedi 15 h libéré au profit d’Alexis Roussel | Portrait historique disponible par défaut | Désistement confirmé le 2026-07-29 en raison d’un séjour au Japon | Aucun pour cette édition | Ne pas relancer pour 2026 |
| Nicolas Cantu | Planifié | Fondateur de 4NK.Organic | Dimanche 18 h — « Lire les dégâts de l’impression monétaire dans les sols. » | Portrait source reçu ; vignette validée dans `03_Communication/Vignettes/Exports-valides/Intervenants/vignette--nicolas-cantu--lire-les-degats-de-l-impression-monetaire-dans-les-sols--2026-07-27--validee.png` | Vignette, portrait, titre et pitch validés le 2026-07-27 | Actualisation du créneau proche de l’événement, non bloquante pour la communication | Préparer la campagne après Élodie Lué avec un CTA billetterie fort ; omettre l’horaire tant qu’il reste provisoire |
| Cédric Maire | Planifié | À préciser | Samedi 15 h avec Alexis Roussel | Manquant | Changement de co-intervenant enregistré le 2026-07-29 | Photo, titre professionnel, rôle et sujet | Confirmer le nouveau format avec Alexis |
...
| [Christine Jeanneaux](https://www.linkedin.com/in/christine-jeanneaux/) | Planifié | Enseignant-chercheur à l’ESDES Business School | Dimanche 15 h — « Et si on comptait les moutons ? — Anatomie d’un mimétisme autour de Bitcoin » | Portrait reçu dans `03_Communication/Vignettes/Intervenants/intervenant--christine-jeanneaux--portrait--2026-07-27--source.png` | Portrait, titre professionnel et titre de présentation reçus le 2026-07-27 | Confirmation définitive du créneau, biographie courte et validation du portrait | Préparer la vignette et faire confirmer le créneau |
...
| Michel Khazzaka | Planifié | À préciser | Lundi 10 h, salle principale ; sujet à définir | Manquant | Créneau validé le 2026-07-29 en remplacement d’Alexis Roussel | Titre professionnel, sujet, synopsis, format et portrait | Obtenir les éléments éditoriaux et confirmer le format |
| Alexis Roussel | Planifié | À préciser | Samedi 15 h, salle principale, avec Cédric Maire ; reprend le créneau d’Élodie Sogan | Manquant | Nouveau créneau attribué le 2026-07-29 | Confirmation, photo, titre professionnel, sujet et format avec Cédric Maire | Confirmer les éléments éditoriaux et le format de la séquence |
...
3. Le texte exact des conversations, les adresses et les coordonnées ne sont
   jamais copiés ici.
4. Une vignette validée est déposée dans Nextcloud sous
   `03_Communication/Vignettes/Exports-valides/Intervenants/`.
