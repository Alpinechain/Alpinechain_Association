...
campagne V1 prête pour validation. La vignette carrée V1 est conservée dans
`03_Communication/Vignettes/Intervenants/` avec le suffixe
`--en-attente-validation-v1` ; elle ne doit pas être présentée comme validée.
